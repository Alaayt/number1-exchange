...
const translations = {
  ar: {
    ...
    ex_title:'تبادل العملات', ex_send:'أنت ترسل · SEND', ex_recv:'أنت تستلم · RECEIVE', ex_rate:'EXCHANGE RATE', ex_details:'RECIPIENT · بيانات الطلب', ex_email:'EMAIL · البريد الإلكتروني', ex_email_ph:'example@email.com', ex_phone_lbl:'رقم هاتفك الذي ستحول منه', ex_phone_ph:'01XXXXXXXXX', ex_phone_hint:'ℹ️ هذا الرقم للتحقق من هويتك فقط', ex_recv_mgo:'معرف محفظة MoneyGo للاستلام', ex_recv_usdt:'عنوان محفظة USDT TRC20 للاستلام', ex_submit:'إرسال طلب التبادل ←', ex_aml:'أقر بأن الأموال مشروعة وأوافق على سياسة AML', ex_tos:'أوافق على شروط الخدمة وسياسة الخصوصية', ex_note_usdt:'ستظهر لك عنوان محفظتنا لإرسال USDT بعد الضغط على إرسال الطلب', ex_note_mgo:'ستظهر لك معرف حساب MoneyGo الخاص بنا بعد الضغط على إرسال الطلب',
